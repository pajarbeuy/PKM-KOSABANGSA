                ...
                if (isDesktop)
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _buildBalanceDetailTile(icon: Icons.monetization_on_rounded, color: const Color(0xFF27AE60), title: 'Total Pendapatan Kotor', value: _formatRp(_totalRevenue), subtitle: 'Penjualan hasil tani terverifikasi'),
                      const SizedBox(height: 12),
                      ...
                      const SizedBox(height: 12),
                      _buildBalanceDetailTile(icon: Icons.scale_rounded, color: const Color(0xFF2D9CDB), title: 'Total Bobot Panen', value: '$_totalHarvest kg', subtitle: 'Akumulasi bobot hasil panen'),
                    ],
                  ),
              ],
            ),
